...
const Slider = () => {
    return (
        <div className="mb-10">
            ...
            <div className="lg:w-[40%] mx-auto flex align-middle">
                <Swiper
                    spaceBetween={30}
                    loop={true}
                    autoplay={{
                ...
                >
                    ...
                    <SwiperSlide data-hash="slide1">
                        <img src='https://images.unsplash.com/photo-1540574163026-643ea20ade25?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjN8fGZ1cm5pdHVyZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60' className="h-[300px] w-full rounded" alt="" />
                        <h1 className="text-center">Sofa Making and Repairing</h1>
                        <h1 className="text-center">صنع الأريكة وإصلاحها</h1>
                    </SwiperSlide>

                    <SwiperSlide data-hash="slide2">
                        <img src='https://m.media-amazon.com/images/I/81VGQESWuPL._SY355_.jpg' className="h-[300px] w-full rounded" alt="" />
                        <h1 className="text-center">Wallpaper Selling and Fixing</h1>
                        <h1 className="text-center">بيع وتثبيت ورق الحائط</h1>
                    </SwiperSlide>
                    <SwiperSlide data-hash="slide3">
                        <img src='https://images.unsplash.com/photo-1594040226829-7f251ab46d80?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8Y2FycGV0fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60' className="h-[300px] w-full rounded" alt="" />
                    ...
                    <SwiperSlide data-hash="slide4">
                        <img src='/images/curtain.jpg' className="h-[300px] w-full rounded" alt="" />
                    ...
                    <SwiperSlide data-hash="slide5">
                        <img src='/images/majlish.jpg' className="h-[300px] w-full rounded" alt="" />
